...
/**
 * An event filter for an attribute.
 */
export class EventFilter {
  /**
   * Returns an event filter for a string attribute.
   */
  public static stringFilter(stringConditions: StringConditions) {
    ...
    return new EventFilter(conditions);
  }

  /**
   * Returns an event filter for a numeric attribute.
   */
  ...
  /**
   * Returns a event filter for attribute key matching.
   */
  public static existsFilter() {
    return new EventFilter([{ exists: true }]);
  }

  /**
   * Returns an event filter for cidr.
   */
  public static cidrFilter(cidr: string) {
    return new EventFilter([{ cidr: cidr }]);
  }
